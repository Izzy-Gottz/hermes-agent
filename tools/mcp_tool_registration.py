...
def _annotation_read_only_hint(mcp_tool: Any) -> bool:
    ...
    if isinstance(annotations, dict):
        ...
        # so every one of them was recorded write-capable — measured on one
        ...
        # calls like COMPOSIO_SEARCH_TOOLS. Both spellings, attribute first,
        # because that is what the SDK actually exposes.
