...
TRUSTED_REPOS = {
    ...
    "NVIDIA/skills",
    # Impeccable (frontend-design skill): upstream maintains a Hermes-native
    # bundle under .hermes/skills/ and verifies it against hermes-agent
    # releases. Trusted so the vendored live-mode JS bundles (490KB
    # live-browser.js etc.) — which score medium/caution findings by sheer
    # size — install without --force. Dangerous verdicts still block.
    "pbakaus/impeccable",
}
