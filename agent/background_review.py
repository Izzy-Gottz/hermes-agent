...
def _run_review_in_thread(
    ...
    # To turn it back off — globally, or to route it onto a cheaper model —
    # set auxiliary.background_review.enabled: false, or
    # auxiliary.background_review.{provider,model}; no code change.
