...
CANONICAL_PROVIDERS: list[ProviderEntry] = [ProviderEntry(*row) for row in (
    ...
    ("claude-code-cli", "Claude Subscription (Claude Code CLI)", "Claude Pro/Max subscription via the `claude` CLI subprocess (Claude Code native tools + Hermes tools over MCP)"),
