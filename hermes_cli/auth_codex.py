...
def codex_cli_credentials_disabled() -> bool:
    ...
    (HERMES_CLAUDE_CODE_CREDENTIALS, agent/anthropic_credentials.py).
    """
...
def _import_codex_cli_tokens() -> Optional[Dict[str, str]]:
    ...
    Returns None without reading when HERMES_CODEX_CLI_CREDENTIALS=0 (see
    codex_cli_credentials_disabled)."""
